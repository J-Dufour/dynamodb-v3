...
var Table = module.exports = function (name, schema, serializer, clients, logger) {
  this.config = {name : name};
  this.schema = schema;
  this.serializer = serializer;
  this.docClient = clients.docClient;
  this.dynamoDbClient = clients.dynamodb;
  this.log = logger;
...
Table.prototype.sendRequest = function (method, params, callback) {
  ...
  } else if (_.isFunction(self.dynamoDbClient[method])) {
    driver = self.dynamoDbClient;
  }
